...
import com.calcvault.call.onSyncMessageReceived
import com.calcvault.call.sendSyncMessage
...
class WatchSessionNetworkCoordinator(
    ...
    fun stopNetworkCoordination() {
        ...
        socketCallEngine.onSyncMessageReceived = null
        receiveJob?.cancel()
        keepAliveJob?.cancel()
    }
    ...
    fun sendSyncEvent(event: SyncEvent) {
        ...
        try {
            ...
            socketCallEngine.sendSyncMessage(message)
    ...
    private fun startReceiveLoop() {
        socketCallEngine.onSyncMessageReceived = { message ->
            if (isNetworkConnected && message.isNotEmpty()) {
